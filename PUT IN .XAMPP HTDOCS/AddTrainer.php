...
<form acton = "" method = "post">
    <tr>
        ...
        <td><input type= text name = 'license' placeholder = "License" /></td>
...
if (isset($_POST['name'], $_POST['license'], $_POST['address'],$_POST['location']))
{
    $name = mysqli_real_escape_string($conn, $_POST['name']);
    $license = mysqli_real_escape_string($conn, (int)$_POST['license']);
    $address = mysqli_real_escape_string($conn, $_POST['address']);
    $location = mysqli_real_escape_string($conn, $_POST['location']);

    $statement = "INSERT INTO trainer (name, license, address, location)
