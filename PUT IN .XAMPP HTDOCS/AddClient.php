...
if (isset($_POST['name'], $_POST['height'], $_POST['weight'], $_POST['health'], $_POST['address'],  
    $_POST['location'], $_POST['diet'], $_POST['plan']))
{
    ...
    $statement = "INSERT INTO client (name, height, weight, health, address, location, diet, plan) 
                VALUES('$name', '$height', '$weight', '$health', '$address', '$location', '$diet', '$plan')";
    if ($conn->query($statement) === TRUE)
    {
        echo "New record created!";
    }
    else
        echo "Creation failed. " . $statement. "<br>" . $conn->error;
}
$conn->close();
?>